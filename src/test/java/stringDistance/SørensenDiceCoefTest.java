...
public class SørensenDiceCoefTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new SørensenDiceCoef());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("SørensenDiceCoefResults.txt");
        OutputResults outputDistance = new OutputResults("SørensenDiceCoefDistances.txt");
        int performance1=0;
        int performancek=0;
