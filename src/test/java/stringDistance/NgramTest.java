...
public class NgramTest {
    ...
    public void tearDown() throws Exception {
        postprocessing.OutputResults outputResults = new postprocessing.OutputResults("NgramResults.txt");
        postprocessing.OutputResults outputDistance = new postprocessing.OutputResults("NgramDistances.txt");
        int performance1=0;
        int performancek=0;
    ...
    public void distance() {
        ...
        StringKNN knn = new StringKNN(5, new Ngram());
