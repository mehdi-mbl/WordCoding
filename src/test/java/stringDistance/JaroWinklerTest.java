...
public class JaroWinklerTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new JaroWinkler());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("JaroWinklerResults.txt");
        OutputResults outputDistance = new OutputResults("JaroWinklerDistances.txt");
        int performance1=0;
        int performancek=0;
