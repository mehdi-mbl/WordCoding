...
public class CosineSimilarityTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new CosineSimilarity());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("CosineSimilarityResults.txt");
        OutputResults outputDistance = new OutputResults("CosineSimilarityDistances.txt");
        int performance1=0;
        int performancek=0;
