...
public class JaccardIndexTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new JaccardIndex());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("JaccardIndexResults.txt");
        OutputResults outputDistance = new OutputResults("JaccardIndexDistances.txt");
        int performance1=0;
        int performancek=0;
