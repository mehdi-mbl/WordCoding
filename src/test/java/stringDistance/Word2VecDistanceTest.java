...
public class Word2VecDistanceTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new Word2VecDistance(new ContextEncoder("word2vec.modelModel"),new CosineDivergence()));
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("Word2VecDistanceResults.txt");
        OutputResults outputDistance = new OutputResults("Word2VecDistanceDistances.txt");
        int performance1=0;
        int performancek=0;
