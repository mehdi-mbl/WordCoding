...
public class OverlpCoefTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new OverlpCoef());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("OverlpCoefResults.txt");
        OutputResults outputDistance = new OutputResults("OverlpCoefDistances.txt");
        int performance1=0;
        int performancek=0;
