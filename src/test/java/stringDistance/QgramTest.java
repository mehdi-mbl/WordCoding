...
public class QgramTest {
    ...
    public void tearDown() throws Exception {
        postprocessing.OutputResults outputResults = new postprocessing.OutputResults("QgramResults.txt");
        postprocessing.OutputResults outputDistance = new postprocessing.OutputResults("QgramDistances.txt");
        int performance1=0;
        int performancek=0;
    ...
    public void distance() {
        ...
        StringKNN knn = new StringKNN(5, new Qgram());
