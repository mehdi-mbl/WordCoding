...
public class TverskyIndexTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new TverskyIndex());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("TverskyIndexResults.txt");
        OutputResults outputDistance = new OutputResults("TverskyIndexDistances.txt");
        int performance1=0;
        int performancek=0;
