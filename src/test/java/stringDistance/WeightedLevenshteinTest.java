...
public class WeightedLevenshteinTest {
    ...
    public void tearDown() throws Exception {
        postprocessing.OutputResults outputResults = new postprocessing.OutputResults("WeightedLevenshteinResults.txt");
        postprocessing.OutputResults outputDistance = new postprocessing.OutputResults("WeightedLevenshteinDistances.txt");
        int performance1=0;
        int performancek=0;
    ...
    public void distance() {
        ...
        StringKNN knn = new StringKNN(5, new WeightedLevenshtein());
