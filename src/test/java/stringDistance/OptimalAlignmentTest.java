...
public class OptimalAlignmentTest {
    ...
    public void tearDown() throws Exception {
        postprocessing.OutputResults outputResults = new postprocessing.OutputResults("OptimalAlignmentResults.txt");
        postprocessing.OutputResults outputDistance = new postprocessing.OutputResults("OptimalAlignmentDistances.txt");
        int performance1=0;
        int performancek=0;
    ...
    public void distance() {
        ...
        StringKNN knn = new StringKNN(5, new OptimalAlignment());
