...
public class EpisodeTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new Episode());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("EpisodeResults.txt");
        OutputResults outputDistance = new OutputResults("EpisodeDistances.txt");
        int performance1=0;
        int performancek=0;
