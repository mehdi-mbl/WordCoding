...
public class LongestCommonSubsequenceTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new LongestCommonSubsequence());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("LongestCommonSubsequenceResults.txt");
        OutputResults outputDistance = new OutputResults("LongestCommonSubsequenceDistances.txt");
        int performance1=0;
        int performancek=0;
