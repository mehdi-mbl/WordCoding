...
public class HammingTest {
    ...
    public void DistanceTest(){
        ...
        StringKNN knn = new StringKNN(5, new Hamming());
    ...
    public static void tearDown() throws Exception {
        /*OutputResults outputResults = new OutputResults("HammingResults.txt");
        OutputResults outputDistance = new OutputResults("HammingDistances.txt");
        int performance1=0;
        int performancek=0;
